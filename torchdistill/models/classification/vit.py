...
import torchdistill.models.classification.vit_configs as configs
...
class VisionTransformer(nn.Module):
    ...
    def forward(self, x, labels=None):
        ...
        if labels is not None:
            ...
            return logits # use foward hook to get attn_weights
...
@register_model_func
def ViT(vit_config,img_size,num_classes, zero_head, vis, model_path=None):
    model = VisionTransformer(CONFIGS[vit_config],img_size,num_classes, zero_head, vis)
